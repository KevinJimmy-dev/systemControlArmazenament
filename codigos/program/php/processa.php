...
if ($nome_produto == "" || $categoria_produto == "" || $quantidade_produto == "" || $validade_produto == "" || $entrega_produto == "") {
    ...
    echo "<script>window.location.href = 'cadastrar_produto.php';</script>";
    ...
    $_SESSION['msg'] = "<p style='color:green;'>Um novo produto foi cadastrado!</p>" . $tabela;

    header("Location: areaPrivada.php");
} else {
    //Mensagem caso de algum problema, e realoca para a página inicial...
    $_SESSION['msg'] = "<p style='color:red;'>O Produto não foi cadastrado!</p>";
    header("Location: areaPrivada.php");
}
